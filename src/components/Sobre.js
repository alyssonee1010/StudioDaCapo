        ...
        <Route path='/about' component={Sobre}>
          <div id='SBA'> 
            <bloco className='MVV'>
              ...
              {ap === "StudioDaCapo" && <Sobre2 text= {textao} />}           
